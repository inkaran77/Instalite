...
|----------------------+--------------+------------+------|
| *Abonné/Abonnements* |              |            |      |
| GetAllMyFollowers    | Ganeistan    | Inkaran OK |      |
| GetAllMyFollowings   | Ganeistan    | Inkaran OK |      |
| GetWaitingList       | Ganeistan    | Inkaran OK |      |
| Follow               | Ganeistan    | Inkaran OK |      |
| Unfollow             | Ganeistan    | Inkaran OK |      |
| AcceptFollower       | Ganeistan    | Inkaran OK |      |
| RefuseFollowRequest  | Ganeistan    | Inkaran OK |      |
| DeleteFollower       | Ganeistan    | Inkaran OK |      |
