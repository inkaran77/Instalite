...
- [[#contrat-daccès][Contrat d'accès]]
  ...
  - [[#file-dactualité][File d'actualité]]
    ...
    - [[#alreadyliked-loading][AlreadyLiked (loading...)]]
  ...
  - [[#abonnéabonnements][Abonné/Abonnements]]
    ...
    - [[#getavailableusers-loading-][GetAvailableUsers (loading) ...]]
...
<<<<<<< HEAD
| DeletePost           | Ganeistan OK | Inkaran OK |      |
| GetPost              | Ganeistan OK | Inkaran OK |      |
| Like                 | Ganeistan    | Inkaran OK |      |
| AlreadyLiked         | Ganeistan    | Inkaran OK |      |
| Comment              | Ganeistan    | Inkaran OK |      |
| GetAllComments       | Ganeistan OK | Inkaran OK |      |
| GetMyNewsFeed        | Ganeistan    | Inkaran OK |      |
=======
| DeletePost           | Ganeistan OK | Inkaran    | KO   |
| GetPost              | Ganeistan OK | Inkaran OK | KO   |
| Like                 | Ganeistan OK | Inkaran    |      |
| Comment              | Ganeistan OK | Inkaran OK | KO   |
| GetAllComments       | Ganeistan OK | Inkaran    | KO   |
| GetMyNewsFeed        | Ganeistan OK | Inkaran OK | OK   |
>>>>>>> af1a07d3658338ecbeddbc83d0e8b642696ee391
...
<<<<<<< HEAD
| GetAvailableUsers    | Mohamed      | Inkaran OK |      |
=======
| Discovery            | Mohamed      | Inkaran    |      |
>>>>>>> af1a07d3658338ecbeddbc83d0e8b642696ee391
|----------------------+--------------+------------+------|
| *Notification*       |              |            |      |
